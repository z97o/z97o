"""
Django settings for omantel project.
Generated and customized for local development.
"""
...
WSGI_APPLICATION = "omantel.wsgi.application"
...
if DATABASE_URL:
    DATABASES = {
        "default": dj_database_url.config(
            ...
            conn_max_age=600,
            ssl_require=True,   # Render Postgres غالبًا يحتاج SSL
        )
    }
else:
    DATABASES = {
...
ALERT_ADMIN_EMAIL = "your_email@example.com"
DEFAULT_FROM_EMAIL = "NetInsight Alerts <no-reply@netinsight.local>"
